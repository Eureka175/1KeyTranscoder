...
# ===========================================================================
# arbitrary-reference delay correction (next development cycle)
# ===========================================================================

#: 本阶段的 channel_sync 算法版本 (estimate_pair 的既有标定, 未改动)
...
SUITES: dict[str, list[tuple[str, Callable[[], None]]]] = {
    "unit": [
        ...
        ("audio sync (arbitrary reference)", l1_audio_sync),
        ("av1", l1_av1),
    ...
    "full": [("pipeline", l3_pipeline),
             ...
             ("audio sync (arbitrary reference)", l3_audio_sync),
